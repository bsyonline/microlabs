...
//
//public class CustomWebSocketServerProtocolHandshakeHandler extends ChannelInboundHandlerAdapter {
//
...
//        try {
//            if (req.method() != GET) {
//                sendHttpResponse(ctx, req, new DefaultFullHttpResponse(HttpVersion.HTTP_1_1, FORBIDDEN));
//                return;
//            }
//
...
//
//        httpHeaders.add(HttpHeaderNames.SET_COOKIE, ServerCookieEncoder.encode(cookie));
//        return httpHeaders;
//    }
//}