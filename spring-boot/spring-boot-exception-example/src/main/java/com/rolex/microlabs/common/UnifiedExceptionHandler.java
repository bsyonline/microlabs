...
import com.rolex.microlabs.common.enums.ClientExceptionEnum;
import com.rolex.microlabs.common.enums.CommonExceptionEnum;
import com.rolex.microlabs.common.enums.ServletExceptionEnum;
...
public class UnifiedExceptionHandler {
    ...
    public String getMessage(BaseException e) {
        String code = "response." + e.getExceptionResponse().toString();
    ...
    public ErrorResponse handleBusinessException(BaseException e) {
        ...
        return new ErrorResponse(e.getExceptionResponse().getCode(), getMessage(e));
    }
    ...
    private ErrorResponse wrapperBindingResult(BindingResult bindingResult) {
        ...
        return new ErrorResponse(ClientExceptionEnum.VALID_ERROR.getCode(), msg.substring(2));
    }
    ...
    public ErrorResponse handleException(Exception e) {
        ...
        return new ErrorResponse(CommonExceptionEnum.SERVER_ERROR.getCode(), e.getMessage());
    }
